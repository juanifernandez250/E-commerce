        ...
        <section class="productos">
            ...
            <div class="grid-productos">
                <article class="producto">
                    <a href="#">
                    <img src="./assets/images/producto1.webp" alt="Producto 1">
                    <h4>Juguete Tipo Kong Grande</h4>
                    <p>Juguete Canino Rellenable Para Cachorros Y Perros. Es un artículo de alta calidad.</p>
              ...
              <article class="producto">
                <a href="#">
                  <img src="./assets/images/producto2.webp" alt="Producto 2">
                  <h4>Colchon Perros de Lona Grande con Cierre 105cm x 65cm</h4>
                  <p>Colchon Antidesgarro Impermeable con Funda. Ideal para cualquier ocasión.</p>
              ...
              <article class="producto">
                <a href="#">
                  <img src="./assets/images/producto3.webp" alt="Producto 3">
                  <h4>Conjunto Collar Y Correa Liso Talle 3</h4>
                  <p>Conjunto Collar Y Correa Liso Talle 3. Calidad garantizada.</p>
              ...
              <article class="producto">
                <a href="#">
                  <img src="./assets/images/producto4.webp" alt="Producto 4">
                  <h4>Comedero/Bebedero Acero de Plata 14cm</h4>
                  <p>Consiente a tus mascotas con el bebedero y comedero Vonne Acero Inoxidable en color plateado y con una capacidad de 350 mL. Este práctico y elegante accesorio es perfecto para mantener a tus perros y gatos hidratados y alimentados de manera cómoda y segura. </p>
                  <span class="precio">$1.000</span>
                </a>
                <div class="contenedor-bottom">
                    <div class="quantity-container">
              ...
              <article class="producto">
                <a href="#">
                  <img src="./assets/images/producto4.webp" alt="Producto 6">
                  <h4>Comedero/Bebedero Acero de Plata 16cm</h4>
                  <p>Consiente a tus mascotas con el bebedero y comedero Vonne Acero Inoxidable en color plateado y con una capacidad de 400 mL. Este práctico y elegante accesorio es perfecto para mantener a tus perros y gatos hidratados y alimentados de manera cómoda y segura. </p>
                  <span class="precio">$1.500</span>
                </a>
                <div class="contenedor-bottom">
                    <div class="quantity-container">
              ...
              <article class="producto">
                <a href="#">
                  <img src="./assets/images/producto4.webp" alt="Producto 6">
                  <h4>Comedero/Bebedero Acero de Plata 18cm</h4>
                  <p>Consiente a tus mascotas con el bebedero y comedero Vonne Acero Inoxidable en color plateado y con una capacidad de 500 mL. Este práctico y elegante accesorio es perfecto para mantener a tus perros y gatos hidratados y alimentados de manera cómoda y segura. </p>
                  <span class="precio">$2.000</span>
                </a>
                <div class="contenedor-bottom">
                    <div class="quantity-container">
              ...
              <article class="producto">
                <a href="#">
                  <img src="./assets/images/producto5.webp" alt="Producto 6">
                  <h4>Peine Cepillo</h4>
                  <p>Peine Cepillo Deslanador Perro Mediano Peluqueria Canina Color Naranja Oscuro</p>
              ...
              <article class="producto">
                <a href="#">
                  <img src="./assets/images/producto6.webp" alt="Producto 6">
                  <h4>Bolso Transportador Mascotas</h4>
                  <p>Bolso Transportador Mascotas Color Gris</p>
