            ...
            <div class="cart-items">
              <article class="cart-item">
                ...
                <div class="cart-item-details"> 
                  <h4>Producto 1</h4>
                  <p>Talla: M | Color: Negro</p>
                  <span class="cart-item-price">$1.500</span>
                ...
                <div class="cart-totals">
                    <p>Subtotal: <span class="subtotal">$1.500</span></p>
                    <p>Envío: <span class="shipping">Gratis</span></p>
                    <p>Total: <span class="total">$1.500</span></p>
                    <button class="cart-checkout-button">Pagar</button>
                </div>
        </section>
    </main>
</body>
