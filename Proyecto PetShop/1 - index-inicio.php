...
<body>
    <main>
        <section class="banner">
          ...
          <video src="./assets/images/banner.mp4" loop></video>
       
          <h2>¡Todo lo que tu mascota necesita!</h2>
          <p>Encuentra alimentos, accesorios, juguetes y más para tu fiel amigo.</p>
          <a href="./3 - index-Productos.html" class="btn-comprar">Comprar ahora</a>
        </section>
      ...
      <section class="productos-destacados">
        ...
        <article class="producto">
          <a href="#">
            ...
            <h4>Juguetes para Perros</h4>
            <p>Juguetes para perros de todas las razas.</p>
          </a>
        </article>
        <article class="producto">
          <a href="#">
            <img src="./assets/images/producto2.webp" alt="Producto 2">
            <h4>Comodidad para tu mascota</h4>
            <p>Gran variedad de camas para mantener comodo a tu perro.</p>
          </a>
        </article>
        <article class="producto">
          <a href="#">
            <img src="./assets/images/producto3.webp" alt="Producto 3">
            <h4>Correas para Perros</h4>
            <p>Encuentra la correa perfecta para tu paseo diario.</p>
          </a>
        </article>
      </section>
</body>
