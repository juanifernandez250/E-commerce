...
<head>
    ...
    <title>Eliminar/Editar Producto </title>
        ...
        <?php
            ...
            if ($resultado->num_rows > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>";
                    echo "<td>" . $fila['product_id'] . "</td>";
                    echo "<td>" . $fila['product_nombre'] . "</td>";
                    echo "<td>" . $fila['product_marca'] . "</td>";
                    echo "<td>" . $fila['product_categoria'] . "</td>";
                    echo "<td>" . $fila['product_stock'] . "</td>";
                    echo "<td>" . $fila['product_precio'] . "</td>";
                    echo "<td>" . $fila['product_descripcion'] . "</td>";
                    echo "<td>";
                    echo "<a href='editar.php?id=" . $fila['product_id'] . "'><span class='editar'>Editar  </span></a> <br>";  //Editar
                    echo "<a href='eliminar.php?id=" . $fila['product_id'] . "'><span class='eliminar'>Eliminar </span></a>";  //Eliminar
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr>";
                echo "<td colspan='4'>No hay datos en la tabla</td>";
                echo "</tr>";
            }
...
?>
      ...
      <a href="./Agregar.php"><button id="addNewProductButton">Agregar Nuevo Producto</button></a>
    </section>
</body>
