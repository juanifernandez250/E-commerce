...
<body>
    <main>
            ...
            <section class="quienes-somos">
              <div class="container">
                <h2>¿Quiénes Somos?</h2>
                <p>Somos una tienda de mascotas apasionada por brindarles a nuestros clientes y sus peludos amigos la mejor experiencia posible. Ofrecemos una amplia variedad de productos de alta calidad, desde alimentos y accesorios hasta juguetes y servicios.</p>
                <p>Nuestro equipo está formado por amantes de los animales que se dedican a brindarle el mejor servicio al cliente. Estamos siempre dispuestos a ayudarlo a encontrar el producto perfecto para su mascota y a responder cualquier pregunta que tenga.</p>
                <p>Creemos que las mascotas son parte de la familia y que merecen lo mejor. Por eso, nos esforzamos por ofrecer productos y servicios que ayuden a mantener a sus mascotas felices y saludables.</p>
              </div>
              <div class="mision-vision">
                <div class="mision">
                  <h3>Misión</h3>
                  <p>Nuestra misión es brindarles a nuestros clientes y sus peludos amigos la mejor experiencia posible, ofreciendo productos de alta calidad, un servicio al cliente excepcional y un ambiente cálido y acogedor.</p>
                </div>
                <div class="vision">
                  <h3>Visión</h3>
                  <p>Ser la tienda de mascotas líder en la región, reconocida por nuestra calidad, servicio y compromiso con el bienestar animal.</p>
                </div>
              </div>
            </section>
