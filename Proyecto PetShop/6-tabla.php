...
<body>
        ...
        <button id="addNewProductButton">Agregar Nuevo Producto</button>
        </section>
    
        <div id="addEditProductModal" class="modal">
        <div class="modal-content">
            ...
            <input type="number" id="productStock" name="productStock" required min="1">
